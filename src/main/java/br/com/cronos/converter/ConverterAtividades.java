...
@Named("converterAtividades")
public class ConverterAtividades implements Converter{

	@Inject
	private GenericDAO<AtividadeEvento> dao;
	...
	public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
		if (value != null && value.trim().length() > 0) {
			try {
			 ...
			 return dao.buscarPorId(AtividadeEvento.class, Long.parseLong(value));
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		if (!(value instanceof AtividadeEvento)) return null;
		    return  String.valueOf(((AtividadeEvento) value).getId());
